...
public class Panelvorlage extends JPanel {
	...
	private void initGUI() {
		...
		this.setSize(BoundsCalc.calcWidth(1920), BoundsCalc.calcHeight(1022)); 
	}
	...
	public void setUeberschrift(String Ueberschrift) {
		...
		setLayout(null);
		this.setSize(BoundsCalc.calcWidth(1920), BoundsCalc.calcHeight(1080)); 
	}
	...
	public void paint(Graphics g) {
		...
		try {
			...
			label.setBounds(BoundsCalc.calcBounds(1430, 15, 50, 50));
			add(label);
		} catch (IOException e) {
