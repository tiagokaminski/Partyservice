...
public class Sortiment extends Panelvorlage {
	...
	private void initGUI() {
		...
		{
			textFieldSuchleiste = new JTextField();
			textFieldSuchleiste.setFont(new Font("Tahoma", Font.PLAIN, 22));
			textFieldSuchleiste.setBounds(269, 21, 1063, 48);
			add(textFieldSuchleiste);
	...
	protected void liveSucheFeld(KeyEvent e) throws ClassNotFoundException {
		...
		String eingabe = this.textFieldSuchleiste.getText();
		ArrayList<Produkt> suchleiste = dao.lifesuche(eingabe);
		DefaultListModel<String> listmodel = new DefaultListModel<>();

		for(Produkt a: suchleiste) {
